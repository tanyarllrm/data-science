...
For the plot on the left, it had a slower learning rate and took 25000 iterations to estimate the parameters.  The plot on the right had a faster learning rate and took 16207 iterations.  The plot where alpha was the highest of 0.1 was not able to be computed because it resulted in the cost increasing.  This is due to the face that the learning rate is so high that the estimation is going right past the optimal location and increasing in the opposite direction.  As alpha decreases, the learning rate is slower and there are more iterations taken before it completes the parameter estimations

[NOW TALK ABOUT WHAT HAPPENS IN TERMS OF UNDERFITTING AND ALPHA]
