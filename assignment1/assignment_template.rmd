...
In the plot, the blue points represent loss from SGD and the orange points represent loss from BGD.  The losses are quite similar; however, the algorithm that yielded the lower loss was BGD.  This makes sense because SGD is only considering one data point at a time when updating theta; on the other hand, BGD is considering all data points at once then updating theta values.  